...
local function updateTorque(device, dt)
    ...
    if torque < 0 then torque = torque * 2 end
    ...
    device.inductionPressure = device.pressureSmoother:getUncapped(pressureFromMap, dt)
...
local function new(jbeamData)
    local device = {
        ...
        pressureSmoother = newTemporalSmoothing(5),
        engineLoad = 0,
        instantEngineLoad = 0,
        exhaustFlowCoef = 0,
